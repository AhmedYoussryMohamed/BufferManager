...
public class DB implements GlobalConst {
  ...
  public  void read_page(PageId pageno, Page apage)
    ...
    try{
      fp.read(buffer);
      try {
			 int data = Convert.getIntValue ( 0, buffer );
//			System.out.println("Dataaaaaaaaaaaa " + data +" ----------------------" );
  ...
  private void pinPage(PageId pageno, Page page, boolean emptyPage)
    ...
    try {
    	// true added manually here.
      SystemDefs.JavabaseBM.pinPage(pageno, page, emptyPage ,loved);
    }
    catch (Exception e) {
  ...
  private void unpinPage(PageId pageno, boolean dirty)
    ...
    try {
    	// true added manually here.
      SystemDefs.JavabaseBM.unpinPage(pageno, dirty,true); 
    }
    catch (Exception e) {
